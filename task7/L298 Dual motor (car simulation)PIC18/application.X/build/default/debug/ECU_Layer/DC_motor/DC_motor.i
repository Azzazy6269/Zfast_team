# 1 "ECU_Layer/DC_motor/DC_motor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECU_Layer/DC_motor/DC_motor.c" 2
...
# 8 "ECU_Layer/DC_motor/DC_motor.c" 2
...
# 38 "ECU_Layer/DC_motor/DC_motor.c"
Std_ReturnType dc_motor_turn_right (const dc_motor_t * _dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
     if(((void*)0)==_dc_motor){
           ret = (Std_ReturnType)0x00;
...
# 56 "ECU_Layer/DC_motor/DC_motor.c"
Std_ReturnType dc_motor_turn_left (const dc_motor_t * _dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
     if(((void*)0)==_dc_motor){
            ret = (Std_ReturnType)0x00;
...
# 74 "ECU_Layer/DC_motor/DC_motor.c"
Std_ReturnType dc_motor_stop (const dc_motor_t * _dc_motor){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
     if(((void*)0)==_dc_motor){
            ret = (Std_ReturnType)0x00;
