...
# 12 "./MCAL_Layer/mcal_std_types.h" 2
...
# 1 "./ECU_Layer/ECU_layer_intialize.h" 1
# 12 "./ECU_Layer/ECU_layer_intialize.h"
# 1 "./ECU_Layer/DC_motor/DC_motor.h" 1
# 12 "./ECU_Layer/DC_motor/DC_motor.h"
...
# 12 "./ECU_Layer/DC_motor/DC_motor.h" 2
...
# 12 "./ECU_Layer/ECU_layer_intialize.h" 2
...
# 14 "./MCAL_Layer/Interrupt/interrupt_config.h"
...
int main() {
    ...
    ccp1_obj.CCP_mode_variant = ((uint8)0x0C);
...
# 41 "application.c"
    timer2_obj.TMR2_InterruptHandler = ((void*)0);
    timer2_obj.timer2_postscaler_value = 0;
