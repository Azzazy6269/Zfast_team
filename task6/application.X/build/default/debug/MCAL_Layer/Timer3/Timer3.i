...
# 12 "MCAL_Layer/Timer3/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h" 1
# 11 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h"
# 1 "MCAL_Layer/Timer3/../GPIO/../compiler.h" 1
# 11 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h" 2
...
# 12 "MCAL_Layer/Timer3/../GPIO/../mcal_std_types.h" 2
...
# 34 "MCAL_Layer/Timer3/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW =0,
    GPIO_HIGH
}logic_t;
...
# 13 "MCAL_Layer/Timer3/Timer3.h" 2

# 1 "MCAL_Layer/Timer3/../Interrupt/Internal_interrupt.h" 1
# 12 "MCAL_Layer/Timer3/../Interrupt/Internal_interrupt.h"
# 1 "MCAL_Layer/Timer3/../Interrupt/Interrupt_config.h" 1
# 14 "MCAL_Layer/Timer3/../Interrupt/Interrupt_config.h"
# 1 "MCAL_Layer/Timer3/../Interrupt/Interrupt_gen_cfg.h" 1
# 14 "MCAL_Layer/Timer3/../Interrupt/Interrupt_config.h" 2
# 62 "MCAL_Layer/Timer3/../Interrupt/Interrupt_config.h"
typedef enum{
   INTERRUPT_LOW_PRIORITY =0,
   INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/Timer3/../Interrupt/Internal_interrupt.h" 2
# 14 "MCAL_Layer/Timer3/Timer3.h" 2
# 48 "MCAL_Layer/Timer3/Timer3.h"
typedef struct{
...
# 8 "MCAL_Layer/Timer3/Timer3.c" 2
...
Std_ReturnType Timer3_Init(const timer3_t * _timer){
    ...
    (T3CONbits.TMR3ON = 0);
    (T3CONbits.T3CKPS = _timer->timer3_prescaler_value);
...
static __attribute__((inline)) void Timer3_Mode_select(const timer3_t *_timer){
     if(0 == _timer->timer3_mode ){
        ...
        (T3CONbits.TMR3CS = 1);
        if(1 == _timer->timer3_counter_mode){(T3CONbits.T3SYNC = 1);}
        else if(0 == _timer->timer3_counter_mode){(T3CONbits.T3SYNC = 0);}
        else{ }
    }
    else { }
}
