...
# 12 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h" 1
# 11 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h"
# 1 "MCAL_Layer/Timer1/../GPIO/../compiler.h" 1
# 11 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h" 2
...
# 12 "MCAL_Layer/Timer1/../GPIO/../mcal_std_types.h" 2
...
# 34 "MCAL_Layer/Timer1/../GPIO/hal_gpio.h"
typedef enum {
    GPIO_LOW =0,
    GPIO_HIGH
}logic_t;
...
# 14 "MCAL_Layer/Timer1/../Interrupt/Interrupt_config.h"
# 1 "MCAL_Layer/Timer1/../Interrupt/Interrupt_gen_cfg.h" 1
# 14 "MCAL_Layer/Timer1/../Interrupt/Interrupt_config.h" 2
# 62 "MCAL_Layer/Timer1/../Interrupt/Interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) void Timer1_Mode_select(const timer1_t *_timer){
    if(0 == _timer->timer1_mode ){
        ...
        (T1CONbits.TMR1CS =1);
        if(1 == _timer->timer1_counter_mode){(T1CONbits.T1SYNC = 1);}
        else if(0 == _timer->timer1_counter_mode){(T1CONbits.T1SYNC = 0);}
        else{ }
    }
    else { }
}
