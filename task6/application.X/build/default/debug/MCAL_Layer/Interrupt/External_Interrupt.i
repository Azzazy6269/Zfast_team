...
# 1 "MCAL_Layer/Interrupt/Interrupt_gen_cfg.h" 1
# 14 "MCAL_Layer/Interrupt/interrupt_config.h" 2
# 62 "MCAL_Layer/Interrupt/interrupt_config.h"
typedef enum{
   INTERRUPT_LOW_PRIORITY =0,
   INTERRUPT_HIGH_PRIORITY
}interrupt_priority_cfg;
# 12 "MCAL_Layer/Interrupt/External_interrupt.h" 2
# 87 "MCAL_Layer/Interrupt/External_interrupt.h"
typedef enum{
...
# 50 "MCAL_Layer/Interrupt/External_Interrupt.c"
Std_ReturnType Interrupt_INTx_Init (const interrupt_INTx_t *int_obj){
   ...
   if(((void*)0) == int_obj){
       ...
       switch (int_obj->source){
           ...
           case INTERRUPT_EXTERNAL_INT1 :
              ...
              (RCONbits.IPEN = 1);
              if(int_obj->priority == INTERRUPT_LOW_PRIORITY){(INTCONbits.GIEL = 1);}
               else if(int_obj->priority == INTERRUPT_HIGH_PRIORITY){(INTCONbits.GIEH = 1);}
...
static Std_ReturnType Interrupt_INTx_Disable(const interrupt_INTx_t * int_obj){
   ...
   if(((void*)0) == int_obj){
       ...
       switch (int_obj->source){
           case INTERRUPT_EXTERNAL_INT0 : (INTCONbits.INT0E = 0) ; break ;
...
static Std_ReturnType Interrupt_INTx_Priority_Init(const interrupt_INTx_t * int_obj){
   ...
   if(((void*)0) == int_obj){
       ...
       switch (int_obj->source){
           case INTERRUPT_EXTERNAL_INT1 :
               if(int_obj->priority == INTERRUPT_LOW_PRIORITY){(INTCON3bits.INT1IP = 0);}
               else if(int_obj->priority == INTERRUPT_HIGH_PRIORITY){(INTCON3bits.INT1IP = 1);}
               else{ };
               break ;

           case INTERRUPT_EXTERNAL_INT2 :
               if(int_obj->priority == INTERRUPT_LOW_PRIORITY){(INTCON3bits.INT2IP = 0);}
               else if(int_obj->priority == INTERRUPT_HIGH_PRIORITY){(INTCON3bits.INT2IP = 1);}
               else{ };
               break ;
   }
   return ret;
...
static Std_ReturnType Interrupt_INTx_Edge_Init(const interrupt_INTx_t * int_obj){
   ...
   if(((void*)0) == int_obj){
       ...
       switch (int_obj->source){
           case INTERRUPT_EXTERNAL_INT0 :
               if(int_obj->edge == INTERRUPT_FALLING_EDGE){(INTCON2bits.INTEDG0 =0);}
               else if(int_obj->edge == INTERRUPT_RISING_EDGE){(INTCON2bits.INTEDG0 =1);}
               else{ };
               break ;
           case INTERRUPT_EXTERNAL_INT1 :
               if(int_obj->edge == INTERRUPT_FALLING_EDGE){(INTCON2bits.INTEDG1 =0);}
               else if(int_obj->edge == INTERRUPT_RISING_EDGE){(INTCON2bits.INTEDG1 =1);}
               else{ };
               break ;

           case INTERRUPT_EXTERNAL_INT2 :
               if(int_obj->edge == INTERRUPT_FALLING_EDGE){(INTCON2bits.INTEDG2 =0);}
               else if(int_obj->edge == INTERRUPT_RISING_EDGE){(INTCON2bits.INTEDG2 =1);}
               else{ };
               break ;
   }
   }
